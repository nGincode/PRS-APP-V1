<!DOCTYPE html>
        ...
        <div class="box">
          <div class="box-header">
            ...
            <h3 class="box-title" style="width: 100%;"><center><font style="font-size: x-large;font-weight: 700;">CV. Prima Rasa Selaras</font></center><hr> <br><B>LAPORAN PENGADAAN <?php echo $store?></B><br>
...
?>
    ...
    margin-left: 40px;
">
      Manajer <br><?php echo $store?><br><br><br><br><?php echo $namadepan;?> <?php echo $namabelakang;?>
    </div>
     <div style="
     float: right;
    text-align: center;
