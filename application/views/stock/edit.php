        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('stock/update') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              ...
              <?php if ($stock_data['img']) { ?>
                <img width="100%" src="<?= base_url() . 'uploads/stock/' . $stock_data['img'] ?>">
              <?php } ?>
              ...
              <table class="table table-bordered" id="product_info_table" style="overflow-x: scroll;display:block;">
                ...
                <tbody>
                  ...
                  <tr id="row_1">
                    ...
                    <td>
                      <input type="text" class="form-control" disabled value="<?php if ($harga) {
                                                                                echo $harga . "/" . $satuan;
                                                                              } else {
                                                                                echo "0/" . $satuan;
                                                                              } ?>">
                    ...
                    <td><input type="number" <?php
                                              if (!in_array('updatestock', $this->permission)) {
                                                echo 'readonly';
                                              } ?> step="any" name="a_unit" id="a_unit_1" class="form-control" required value="<?php echo $stock_data['a_unit']; ?>"></td>


                    <td><input type="number" <?php
                                              if (!in_array('updatestock', $this->permission)) {
                                                echo 'readonly';
                                              } ?> step="any" name="t_unit" onkeyup="apakai1()" id="t_unit_1" class="form-control" required value="<?php echo $stock_data['t_unit']; ?>"></td>


                    <td><input type="number" <?php
                                              if (!in_array('updatestock', $this->permission)) {
                                                echo 'readonly';
                                              } ?> step="any" name="s_unit" onkeyup="apakai1()" id="s_unit_1" class="form-control" required value="<?php echo $stock_data['s_unit']; ?>"></td>
                    ...
                    <td><input type="number" <?php
                                              if (!in_array('updatestock', $this->permission)) {
                                                echo 'readonly';
                                              } ?> step="any" name="reg" id="reg_1" oninput="pemakaian1()" class="form-control" required value="<?php echo $stock_data['reg']; ?>"></td>
                    <td>
                    ...
                    <td><input type="text" name="ket" class="form-control" value="<?php echo $stock_data['ket']; ?>"></td>
                  </tr>
                </tbody>
              </table>
