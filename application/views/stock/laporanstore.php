      ...
      <div class="ccol-md-12 col-xs-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-right">
              <li><a href="#tab_1" data-toggle="tab">Stock Harian</a></li>
              <!--<li><a href="#tab_2" data-toggle="tab">Cek Perproduk</a></li>-->
              <li class="active"><a href="#tab_3" data-toggle="tab">Stock Bulanan</a></li>
        ...
        <?php endif; ?>
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php echo base_url('stock/pdfhari') ?>" method="post" class="form-horizontal" id="datastock">
              <div class="box-body">
                ...
                <select name="divisi2" required class="form-control pull-right">
        ...
        <?php endif; ?>
          ...
          <!-- /.box-header -->
          <form action="<?php echo base_url('stock/pdf') ?>" method="post" class="form-horizontal">
              <div class="box-body">
