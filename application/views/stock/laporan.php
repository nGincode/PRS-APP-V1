        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab_3">
              ...
              <!-- /.box-header -->
              <form role="form" action="akexcel" method="post" enctype="multipart/form-data" class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        ...
                        <div class="input-group date">
                          ...
                          <input type="date" required name="tgl_awal" value="<?= date('Y-m-d', mktime(0, 0, 0, date("m") - 1, '26', date("Y"))); ?>" class="form-control pull-right">
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        ...
                        <div class="input-group date">
                          ...
                          <input type="date" value="<?= date('Y-m') . '-25' ?>" name="tgl_akhir" required class="form-control pull-right">
                        </div>
            ...
            <div class="tab-pane active" id="tab_4">
              ...
              <!-- /.box-header -->
              <form action="<?php echo base_url('stock/export') ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        ...
                        <div class="input-group date">
                          ...
                          <input type="date" required name="tglawal" class="form-control pull-right" value="<?= date('Y-m-d', mktime(0, 0, 0, date("m") - 1, '26', date("Y"))); ?>">
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        ...
                        <div class="input-group date">
                          ...
                          <input type="date" value="<?= date('Y-m') . '-25' ?>" name="tglakhir" required class="form-control pull-right">
                        </div>
