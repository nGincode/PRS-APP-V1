...
<body onload="window.print();">
  <div class="box">
    <div class="box-header">
      <center><img src="<?php echo base_url(); ?>assets/images/logo/prslogin.png" width="100">
        <h3 class="box-title" style="width: 100%;">
          <center>
            <font style="font-size: 200;font-weight: 700;">CV. Prima Rasa Selaras</font>
          </center>
          <hr><B>LAPORAN INVENTARIS <?php echo $store ?></B><br>
