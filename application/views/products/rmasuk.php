    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('products/rmasuk') ?>" method="post" enctype="multipart/form-data">
            <div class="box-body">
      ...
      <div class="box  box-solid">
        <div class="box-header">
          <h3 class="box-title">Stock Rusak</h3>
        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#ProductrusakNav").addClass('active');



    // initialize the datatable 
    manageTable = $('#manageTable').DataTable({
      'ajax': base_url + 'products/laporanstockrusak',
      'order': []
    });
