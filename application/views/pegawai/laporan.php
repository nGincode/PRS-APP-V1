      ...
      <div class="ccol-md-12 col-xs-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-right">
              <li><a href="#tab_1" data-toggle="tab">Laporan Bulanan</a></li>
              <!--<li><a href="#tab_2" data-toggle="tab">Cek Perproduk</a></li>-->
              <li class="active"><a href="#tab_3" data-toggle="tab">Akumulasi</a></li>
              <li class="pull-left header"><i class="fa fa-calendar"></i>Laporan Employe</li>
            </ul>
