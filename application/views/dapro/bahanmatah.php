            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="box box-primary box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title"><b>Barang Baku Dapro</b></h3>
                    ...
                    <div class="box-body" id='penyesuaian'>
                        ...
                        <div class="group">
                            <input type="text" id="jadi1" onchange="ubah1()" name="datefilter" required>
        ...
        $(document).ready(function() {
            ...
            if (da) {
                manageTable = $('#manageTable1').DataTable({
                    ...
                    destroy: true,
                    "ajax": {
                        url: base_url + 'dapro/fatchorderitem',
                        type: "POST",
                        beforeSend: function() {
                            $("#load").css("display", "block");
                        },
