    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if (in_array('createStore', $user_permission)) : ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal"><i class="fa fa-plus"></i> Tambah Store</button>
          <br /> <br />
        <?php endif; ?>
        ...
        <form role="form" action="<?php echo base_url('stores/create') ?>" method="post" id="createForm">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="brand_name">Nama Outlet</label>
              <input type="text" class="form-control" id="store_name" name="store_name" placeholder="Nama Outlet" autocomplete="off">
            </div>
      ...
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('stores/update') ?>" method="post" id="updateForm">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="edit_brand_name">Outlet Name</label>
