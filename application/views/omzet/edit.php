            ...
            <form role="form" method="post">
              <div class="box-body">
               ...
               <div class="form-group">
                  ...
                  <input type="date" class="form-control" name="tgl" readonly="" value="<?php echo $omzet_data['tgl']; ?>" required autocomplete="off">
                </div>


                <div class="form-group">
                  <label for="pemasukan">Pemasukan</label>
                  <input type="number" class="form-control" required="" name="pemasukan" value="<?php echo $omzet_data['pemasukkan']; ?>" autocomplete="off">
                </div>
                
                <div class="form-group">
                  <label for="masuk_kerja">Pengeluaran</label>
                  <input type="number" class="form-control" name="pengeluaran" value="<?php echo $omzet_data['pengeluaran']; ?>" required autocomplete="off">
                </div>


                <div class="form-group">
                  <label for="pettycash">Petty Cash</label>
                  <input type="number" class="form-control" name="pettycash" value="<?php echo $omzet_data['pettycash']; ?>" required  autocomplete="off">
                </div>
